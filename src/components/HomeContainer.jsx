  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full h-[calc(100%-88px)]" id="home">
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <p className="text-base text-headingColor text-center md:text-left md:w-[80%]">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto accusantium praesentium enim deserunt eius nam harum? Dignissimos, minus, repellendus fugit vitae repudiandae exercitationem veniam modi dolor quasi beatae ducimus commodi.
        </p>
